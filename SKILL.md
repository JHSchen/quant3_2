...
### 详细角色规范请参阅：
- Strategy Agent → `references/strategy_agent.md`
- Adversary Agent → `references/adversary_agent.md`
- Risk Agent → `references/risk_agent.md`
- Orchestrator → `references/orchestrator.md`
- [可扩展] Monitor Agent → `references/monitor_agent.md`
- [可扩展] Execution Agent → `references/execution_agent.md`
